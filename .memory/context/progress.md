...
- [x] Food logger — 150+ Indian foods database, fuzzy search, custom food entry
...
- [x] Health plan AI generation
- [x] Gamification: 8 streak types, badge system, XP, leveling
- [x] Achievements page (badge grid, streak overview, progress)
- [x] Settings: profile edit, API key management (OpenAI + Edamam)
- [x] User preferences (units, theme, notifications)
...
- [ ] UI/UX standardization sprint (card classes, gradients, accessibility)
