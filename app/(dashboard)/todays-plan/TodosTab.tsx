...
import { Check, CheckSquare, Clock, Loader2, Settings, Zap } from 'lucide-react';
...
export default function TodosTab() {
  ...
  const virtualItems = useMemo(() => templates.flatMap((t): VirtualTodoItem[] => {
  ...
  if (total === 0) {
    return (
      <div className="dashboard-unified-card rounded-2xl border px-8 py-10 text-center">
        ...
        <p className="mt-3 text-sm font-semibold text-zinc-300">No todos for today</p>
        <Link
  ...
  return (
    <div className="space-y-3">
      <div className="dashboard-unified-card rounded-2xl border p-4">
        <p className="text-xs text-zinc-400">Todo progress</p>
